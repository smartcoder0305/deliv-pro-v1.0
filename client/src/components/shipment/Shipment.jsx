...
const Shipment = () => {
    ...
    return (
        <div className='pt-20 px-20'>
            <CustomNavLink to="/simple-settings">{t('go_back')}</CustomNavLink>
            ...
            <div className='flex'>
                ...
                <div className='w-1/3 flex items-end justify-center'>
                    <div className='flex justify-center'><CustomNavLink to="/shipment-results" className='bg-slate-300 px-5 py-3'>{t('search')}</CustomNavLink></div>
                </div>
            </div>
        </div>
    );
